...
```
    ...
    ##  4     4        69.8 female        16 non-apoe4 carrier <NA>        
    ##  5     5        66   male          16 non-apoe4 carrier 68.7        
    ##  6     6        62.5 male          16 non-apoe4 carrier <NA>        
    ##  7     7        66.5 male          18 non-apoe4 carrier 74          
    ##  8     8        67.2 female        18 non-apoe4 carrier <NA>        
    ##  9     9        66.7 female        16 non-apoe4 carrier <NA>        
    ## 10    10        64.1 female        18 non-apoe4 carrier <NA>        
    ## # ℹ 469 more rows
...
```
    ...
    ## # A tibble: 2,435 × 3
    ##       id timeperiod `time in years elapsed`
    ##    <dbl> <chr>      <chr>                  
...
and use pivot_longer to transpose data from wider to longer.
