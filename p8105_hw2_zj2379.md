...
```
    ...
    ## # A tibble: 340 × 6
    ##    ID    time_since_baseline time2       time4       time6       time8      
...
I first rename each column and remove observations with missing values.
There were originally 496 individuals, while only 340 of them have
completed records.
...
31 participants found unique to the baseline dataset and 274
participants found unique to the amyloid dataset. 66 appear in both
datasets.
